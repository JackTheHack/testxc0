...
##################################
# Configure Commerce Variables
##################################

Set-EnvFileVariable "XC_IDENTITY_COMMERCEENGINECONNECTCLIENT_CLIENTSECRET1" -Value (Get-SitecoreRandomString 64 -DisallowSpecial)
Set-EnvFileVariable "REPORTING_API_KEY" -Value (Get-SitecoreRandomString 128)
...
Push-Location devops\docker\traefik\certs
try {
    $mkcert = ".\mkcert.exe"
    ...
    & $mkcert -cert-file xc0cm.localhost.crt -key-file xc0cm.localhost.key "xc0cm.localhost"
    & $mkcert -cert-file xc0id.localhost.crt -key-file xc0id.localhost.key "xc0id.localhost"
    & $mkcert -cert-file authoring.localhost.crt -key-file authoring.localhost.key "authoring.localhost"
    & $mkcert -cert-file shops.localhost.crt -key-file shops.localhost.key "shops.localhost"
    & $mkcert -cert-file authoring.localhost.crt -key-file authoring.localhost.key "authoring.localhost"
    & $mkcert -cert-file minions.localhost.crt -key-file minions.localhost.key "minions.localhost"
    & $mkcert -cert-file ops.localhost.crt -key-file ops.localhost.key "ops.localhost"
    & $mkcert -cert-file bizfx.localhost.crt -key-file bizfx.localhost.key "bizfx.localhost"        
}
catch {
...
Add-HostsEntry "xc0cm.localhost"
Add-HostsEntry "xc0id.localhost"
Add-HostsEntry "authoring.localhost"
Add-HostsEntry "shops.localhost"
Add-HostsEntry "minions.localhost"
Add-HostsEntry "ops.localhost"
Add-HostsEntry "bizfx.localhost"
