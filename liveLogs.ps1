...
Function Get-LogColor {
 ...
 Try {
    ...
    $FolderPath = 'C:\inetpub\wwwroot\ir.local\App_Data\logs'
    
    Write-Host 'Folder selected: ' $FolderPath -ForegroundColor Green

        $latestLog = Get-ChildItem -Path $FolderPath |Where-Object {$_.Name -like 'log.*'}| Sort-Object LastAccessTime -Descending | Select-Object -First 1
